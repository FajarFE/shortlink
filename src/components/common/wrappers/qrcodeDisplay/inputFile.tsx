...
const FileInput = () => {
	...
	const buttonStyle =
		"w-fit items-center rounded-lg bg-blue-light px-2 py-3 text-white transition-all duration-300 ease-in-out cursor-pointer bg-[#FF204E]";
			...
			<div className='flex flex-col items-center justify-center gap-x-3 gap-y-2 lg:flex-row'>
				...
				<button
					className={clsx(buttonStyle, {
						"cursor-not-allowed opacity-50 bg-[#FF204E]": !state.logoImage,
					})}
					onClick={removeLogo}
