			...
			<Disclosure>
				{({ open }) => (
					<>
						<Disclosure.Button
							className={clsx(
								"mt-5 flex w-full items-center justify-between rounded-lg bg-[#00000] py-5 pl-6 text-left text-sm text-white focus:outline-none focus-visible:ring focus-visible:ring-primary focus-visible:ring-opacity-75",
								{
									"rounded-b-lg": !open,
									"rounded-b-none": open,
								}
						...
						<>
							<Transition
								...
								<Disclosure.Panel
									className={
										"rounded-b-lg bg-secondary-light px-6 pb-8 pt-2 text-sm text-gray-500"
									}>
									{children}
								</Disclosure.Panel>
							</Transition>
...
export const Button = ({
	...
	return (
		<button
			className={clsx(
				"mr-2 flex items-center rounded-lg bg-[#FF204E] px-2 py-3 text-white transition-all duration-300 ease-in-out",
				{
					"bg-[#FF204E]": active && !isColorPicker,
