...
const Layout = ({ children }: TabProps) => {
	...
	useEffect(() => {
		const initialActiveTabIndex = tabsData.findIndex(
			...
			<nav
				...
				<div className={"relative flex-none"}>
					<motion.div
						...
						className={
							"absolute right-0 w-full snap-end rounded-full bg-secondary"
						}
						animate={
					...
					<div
						className={
							"mx-auto flex flex-row space-x-3 md:flex-col md:space-x-0 md:space-y-3"
						}>
